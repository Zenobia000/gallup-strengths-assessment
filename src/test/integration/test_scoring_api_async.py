"""
Async API Integration Tests for Scoring Endpoints

Modern async testing using httpx.AsyncClient and pytest-asyncio.
Resolves Starlette 0.27.0 TestClient compatibility issues.
...
# Test database setup
SQLALCHEMY_TEST_DATABASE_URL = "sqlite:///./test_integration_async.db"
...
class TestScaleConversionAccuracy:
    ...
    @pytest.mark.asyncio
    async def test_minimum_value_conversion(self, client, sample_session):
    ...
    @pytest.mark.asyncio
    async def test_maximum_value_conversion(self, client, sample_session):
    ...
    @pytest.mark.asyncio
    async def test_midpoint_value_conversion(self, client, sample_session):
    ...
    @pytest.mark.asyncio
    async def test_conversion_formula_linearity(self, client, sample_session):
...
class TestAPIEndpointResponseFormat:
    ...
    @pytest.mark.asyncio
    async def test_calculate_endpoint_response_structure(self, client, sample_session, valid_7point_responses):
    ...
    @pytest.mark.asyncio
    async def test_results_endpoint_response_structure(self, client, sample_session, valid_7point_responses):
        ...
        response = await client.get(f"/api/scoring/results/{sample_session.session_id}")
    ...
    @pytest.mark.asyncio
    async def test_metadata_endpoint_response(self, client):
        """Test /metadata endpoint returns engine information."""
        response = await client.get("/api/scoring/metadata")
...
class TestDatabaseIntegration:
    ...
    @pytest.mark.asyncio
    async def test_score_persisted_to_database(self, client, sample_session, valid_7point_responses, db_session):
    ...
    @pytest.mark.asyncio
    async def test_raw_scores_json_format(self, client, sample_session, varied_7point_responses, db_session):
    ...
    @pytest.mark.asyncio
    async def test_retrieve_existing_scores(self, client, sample_session, valid_7point_responses):
        ...
        # Retrieve scores
        get_response = await client.get(f"/api/scoring/results/{sample_session.session_id}")
...
class TestErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_invalid_session_id(self, client, valid_7point_responses):
    ...
    @pytest.mark.asyncio
    async def test_invalid_response_count(self, client, sample_session):
    ...
    @pytest.mark.asyncio
    async def test_invalid_7point_scale_value(self, client, sample_session):
    ...
    @pytest.mark.asyncio
    async def test_retrieve_nonexistent_results(self, client):
        """Test error when retrieving results for non-existent session."""
        response = await client.get("/api/scoring/results/non-existent-session")
...
class TestEndToEndScenarios:
    ...
    @pytest.mark.asyncio
    async def test_complete_assessment_flow(self, client, sample_session, varied_7point_responses):
    ...
    @pytest.mark.asyncio
    async def test_metadata_before_calculation(self, client):
